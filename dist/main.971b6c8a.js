...
},{"process":31}],19:[function(require,module,exports) {
"use strict";
...
exports.default = function (body) {
    ...
    banner.style = {
        ...
        backgroundColor: _colors2.default["off-black"],
        marginBottom: "1.5rem",
    ...
    // Animate
    // 
    (0, _jquery2.default)(banner).fadeIn("slow");
};
...
},{"./colors.json":18,"jquery":22}],29:[function(require,module,exports) {
// 
// 
...
},{"good-js":29}],9:[function(require,module,exports) {
"use strict";
...
var _goodDom = require("good-dom");

var _goodDom2 = _interopRequireDefault(_goodDom);
...
nextBtn.onclick = function () {
    ...
    function loadPage2WithBody() {
        (0, _page2.default)(body);
    }
    // fadeout the innerBody, and once its done, run the loadPage2WithBody() function
    (0, _jquery2.default)(innerBody).fadeOut(loadPage2WithBody);
};
...
innerBody.add(nextBtn);
body.add(innerBody);
},{"./colors.json":18,"./page2":19,"jquery":22,"good-dom":23}],37:[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/main.971b6c8a.map